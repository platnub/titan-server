...
2. Create komodo container
   ...
   curl "https://github.com/platnub/container-host-templates/blob/main/docker/containers/komodo/.env"
   curl "https://github.com/platnub/container-host-templates/blob/main/docker/containers/komodo/compose.yml"
   ```
3. Edit .env file
