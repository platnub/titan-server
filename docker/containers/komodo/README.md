...
2. Create komodo container
   ...
   curl -o compose.yml "https://github.com/platnub/container-host-templates/blob/main/docker/containers/komodo/compose.yml"
   curl -o .env "https://github.com/platnub/container-host-templates/blob/main/docker/containers/komodo/.env"
   ```
3. Edit .env file
